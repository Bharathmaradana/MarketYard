...
import carousel_1 from "../components/css/carousel-1.jpg";
import carousel_2 from "../components/css/carousel-2.jpg";
import about from "../components/css/about.png";
import feature from "../components/css/feature.png";
import product_1 from "../components/css/product-1.png";
import product_2 from "../components/css/product-2.png";
import testimonial_1 from "../components/css/testimonial-1.jpg";
import testimonial_2 from "../components/css/testimonial-2.jpg";
import team_1 from "../components/css/team-1.jpg";
import team_2 from "../components/css/team-2.jpg";
import team_3 from "../components/css/team-3.jpg";
import blog_1 from "../components/css/blog-1.jpg";
import blog_2 from "../components/css/blog-2.jpg";
import blog_3 from "../components/css/blog-3.jpg";
        ...
        <div class="row gx-5 py-3 align-items-center">
          <div class="col-lg-3">
            <div class="d-flex align-items-center justify-content-start">
              ...
              <h2 class="mb-0">+91 8886614949</h2>
            </div>
          </div>
          <div class="col-lg-6">
        ...
        >
          <div class="carousel-inner">
            <div class="carousel-item active">
              <img class="w-100" src={carousel_1} alt="Image" />
            ...
            <div class="carousel-item">
              <img class="w-100" src={carousel_2} alt="Image" />
              <div class="carousel-caption top-0 bottom-0 start-0 end-0 d-flex flex-column align-items-center justify-content-center">
                <div class="text-start p-5" style={{ maxWidth: "900px" }}>
          ...
          <div class="row gx-5">
            <div class="col-lg-6 mb-5 mb-lg-0">
              <div class="d-flex h-100 border border-5 border-primary border-bottom-0 pt-4">
                <img class="img-fluid mt-auto mx-auto" src={about} />
              </div>
            </div>
        ...
        <div class="container">
          <div class="row g-5">
            <div class="col-lg-4 col-md-6">
              ...
              <a href="" class="btn btn-primary py-md-3 px-md-5">
                Contact Us
              </a>
            </div>
            <div class="col-lg-4 col-md-6">
          ...
          <div class="row g-5">
            ...
            <div class="col-lg-6">
              <div class="d-block bg-white h-100 text-center p-5 pb-lg-0">
                ...
                <img class="img-fluid" src={feature} alt="" />
              </div>
            </div>
            <div class="col-lg-3">
              <div class="text-white mb-5">
          ...
          <div class="owl-carousel product-carousel px-5">
            <div class="pb-5">
              <div class="product-item position-relative bg-white d-flex flex-column text-center">
                <img class="img-fluid mb-4" src={product_1} alt="" />
            ...
            <div class="pb-5">
              <div class="product-item position-relative bg-white d-flex flex-column text-center">
                <img class="img-fluid mb-4" src={product_2} alt="" />
                <h6 class="mb-3">Organic Vegetable</h6>
                <h5 class="text-primary mb-0">$19.00</h5>
                <div class="btn-action d-flex justify-content-center">
                  <a class="btn bg-primary py-2 px-3" href="">
          ...
          <div class="row g-5">
              ...
              <div class="row g-0">
                <div class="col-10">
                  <div class="position-relative">
                    <img class="img-fluid w-100" src={team_1} alt="" />
                    <div
            ...
            <div class="col-lg-4 col-md-6">
              <div class="row g-0">
                <div class="col-10">
                  <div class="position-relative">
                    <img class="img-fluid w-100" src={team_2} alt="" />
                    <div
                      class="position-absolute start-0 bottom-0 w-100 py-3 px-4"
                      style={{ background: "rgba(52, 173, 84, .85)" }}
                    >
            ...
            <div class="col-lg-4 col-md-6">
              <div class="row g-0">
                <div class="col-10">
                  <div class="position-relative">
                    <img class="img-fluid w-100" src={team_3} alt="" />
                    <div
                      class="position-absolute start-0 bottom-0 w-100 py-3 px-4"
                      style={{ background: "rgba(52, 173, 84, .85)" }}
                    >
